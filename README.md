...
[![x-FuSa spec](https://img.shields.io/badge/x--FuSa%20spec-v1.15-blue)](https://github.com/soundmatt/x-FuSa)
...
**jfusa** is the Java implementation of the [x-FuSa specification v1.15](https://github.com/soundmatt/x-FuSa) — a tool-qualification-grade functional safety CLI for Java projects targeting ISO 26262, IEC 61508, ISO 21434, DO-178C, IEC 62443, UN R.155, and SLSA.
